		...
		<div class="container">
			<div class="furniture-container homepage-container">
								...
								<div class="row">
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											<div class="row">
												...
												<div class="col-xs-10">
													<h4 class="info-box-heading green">Product Assurance</h4>
												</div>
											</div>
											<h6 class="text">3 Days Money Back Guarantee</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="hidden-md col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">free shipping on order over Tk. 1000.00</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">Up to <b><i>20%</i></b> off on Nagad/bKash payment</h6>
										</div>
									</div><!-- .col -->
								</div><!-- /.row -->
				...
				<section class="section featured-product inner-xs wow fadeInUp">
					<h3 class="section-title">Shoe</h3>
