...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($con, "update  products set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productDescription='$productdescription',stock='$productstock',shippingCharge='$productscharge',size='$productsize',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="stock" placeholder="Enter Product Stock" value="<?php echo htmlentities($row['stock']); ?>" class="span8 tip" required>
												</div>
											</div>
											<div class="control-group">
												<label class="control-label" for="basicinput">Product Size</label>
												<div class="controls">
													<select name="size" id="size" class="span8 tip">
														<option value="S" <?php echo (htmlentities($row['size']) == 'S' ? 'selected' : ''); ?>>S</option><option value="M" <?php echo (htmlentities($row['size']) == 'M' ? 'selected' : ''); ?>>M</option><option value="L" <?php echo (htmlentities($row['size']) == 'L' ? 'selected' : ''); ?>>L</option>
													</select>
												</div>
											</div>
